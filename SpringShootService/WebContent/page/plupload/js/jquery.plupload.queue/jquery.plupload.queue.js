	...
	function b(f, e) {
		...
		e
				.prepend('<div class="plupload_wrapper plupload_scroll"><div id="'
						...
						+ f
						+ '_filelist" class="plupload_filelist"></ul><div class="plupload_filelist_footer"><div class="plupload_file_name"><div class="plupload_buttons"><a href="#" class=" plupload_button plupload_add" style="background: #f3ebde; color: #000000">'
						+ '<span class="btn btn-primary" style="line-height: 0.6;background: #f3ebde; color: #000000">'+a("Add files")+'</span>'
						+ '</a><a href="#" class="btn btn-primary plupload_button plupload_start" style="background: #f3ebde; color: #000000;margin-left: 10px; line-height: 0.6;">'
						+ a("Start upload")
