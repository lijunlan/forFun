		...
		btnGetTeacherInfo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String showWeight16 = String.valueOf((Integer) t
						.get("showWeight16"));
				String homeWeight = String.valueOf((Integer)t.get("homeWeight"));
				String saleWeight = String.valueOf((Integer)t.get("saleWeight"));
				...
				textHomeWeight.setText(homeWeight);
				textSaleWeight.setText(saleWeight);
