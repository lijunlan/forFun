<%@page import="com.sdll18.appservice.Tool.CreatImageTool"%>
...
<%
	...
	String rootPath = CreatImageTool.getOwnerPath();
	//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
	String rootUrl = CreatImageTool.getOwnerUrlPath();
	//图片扩展名
